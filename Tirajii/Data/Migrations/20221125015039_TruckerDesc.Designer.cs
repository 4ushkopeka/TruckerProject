...
namespace Tirajii.Data.Migrations
{
    ...
    [Migration("20221125015039_TruckerDesc")]
    partial class TruckerDesc
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tirajii.Data.Models.TruckOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tirajii.Data.Models.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tirajii.Data.Models.CompanyRatings", b =>
                {
                    ...
                    b.HasOne("Tirajii.Data.Models.Trucker", "Rater")
                        .WithMany("CompaniesRated")
            ...
            modelBuilder.Entity("Tirajii.Data.Models.TruckOffer", b =>
                {
                    ...
                    b.HasOne("Tirajii.Data.Models.Truck", "Truck")
                        .WithOne("TruckOffer")
                        .HasForeignKey("Tirajii.Data.Models.TruckOffer", "TruckId")
            ...
            modelBuilder.Entity("Tirajii.Data.Models.Wallet", b =>
                {
                    b.HasOne("Tirajii.Data.Models.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("Tirajii.Data.Models.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
